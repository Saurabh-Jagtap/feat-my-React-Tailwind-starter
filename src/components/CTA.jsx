    ...
    <div class="container flex flex-col items-center px-4 py-12 mx-auto xl:flex-row">
        ...
        <div class="flex flex-col items-center mt-6 xl:items-start xl:w-1/2 xl:mt-0">
            ...
            <div class="mt-6 sm:-mx-2">
                ...
                <a href="#"
                    class="inline-flex items-center justify-center w-full px-4 text-sm py-2.5 mt-4 overflow-hidden text-white transition-colors duration-300 bg-blue-700 rounded-lg shadow sm:w-auto sm:mx-2 sm:mt-0 hover:bg-blue-600 focus:ring focus:ring-blue-300 focus:ring-opacity-80">
